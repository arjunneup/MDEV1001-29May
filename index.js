...
db.serialize(function(){
    ...
    db.run("INSERT INTO Teaches VALUES(10101, 'CS_101', 1, 'Fall',2009)");
    db.run("INSERT INTO Teaches VALUES(10101, 'CS_315', 1, 'Spring',2010)");
    db.run("INSERT INTO Teaches VALUES(10101, 'CS_347', 1, 'Fall',2019)");
    db.run("INSERT INTO Teaches VALUES(12121, 'FIN-201', 1, 'Spring',2009)");
    db.run("INSERT INTO Teaches VALUES(15151, 'MU-199', 1, 'Sprinsg',2010)");
    db.run("INSERT INTO Teaches VALUES(22222, 'PHY-101', 1, 'Fall',2009)");
    db.run("INSERT INTO Teaches VALUES(23343, 'HIS-351', 1, 'Spring',2010)");
    db.run("INSERT INTO Teaches VALUES(45565, 'CS_101', 1, 'Spring',2009)");
    db.run("INSERT INTO Teaches VALUES(45565, 'CS-319', 1, 'Spring',2010)");
    db.run("INSERT INTO Teaches VALUES(76766, 'BIO-301', 1, 'Summer',2009)");
    db.run("INSERT INTO Teaches VALUES(76766, 'BI0_101', 1, 'Summer',2010)");
    db.run("INSERT INTO Teaches VALUES(83821, 'CS-190', 1, 'Spring',2009)");
    db.run("INSERT INTO Teaches VALUES(83821, 'CS_190', 1, 'Spring',2009)");
    db.run("INSERT INTO Teaches VALUES(83821, 'CS_319', 1, 'Spring',2010)");
    db.run("INSERT INTO Teaches VALUES(98345, 'EE-181', 1, 'Spring',2009)");


    //Match Teaches and Instructor wih the same ID
    //Print Name and course_id
    ...
    // Display all students and the course they have taken 
    ...
    // Display all students and the courses they have taken using views
    // Student name and course naem semester
